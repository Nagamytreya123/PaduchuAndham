...
export function IconShop(props: SvgIconProps) {
  return (
    <SvgIcon {...props}>
      <path d="M20 4H4v2h16V4zm1 3H3c-.55 0-1 .45-1 1v11c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V8c0-.55-.45-1-1-1zm-5 6c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z" />
    </SvgIcon>
  );
}

export function IconHeart(props: SvgIconProps) {
  return (
    <SvgIcon {...props}>
...
export function IconHeartFilled(props: SvgIconProps) {
  return (
    <SvgIcon {...props}>
